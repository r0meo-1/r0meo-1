...
### 💳 Kardo - Backend
**Технологии:** Java  
**Тип:** Backend часть проекта Kardo

Бэкенд часть проекта Kardo. Разработка серверной логики и API.

[🔗 Репозиторий →](https://github.com/r0meo-1/kardo)

### 🎨 Kardo - Frontend
**Технологии:** JavaScript, React  
**Тип:** Frontend часть проекта Kardo

Фронтенд часть проекта Kardo. Разработка пользовательского интерфейса.

[🔗 Репозиторий →](https://github.com/r0meo-1/kardo-frontend)

### 💱 Currency Converter - Backend
**Технологии:** Python  
**Тип:** Backend, Хакатон Яндекс.Практикум

Команда 2. Хакатон Яндекс.Практикум: Сервис для конвертации валют. Backend часть проекта.

[🔗 Репозиторий →](https://github.com/r0meo-1/currency-converter-backend)

### 💱 Currency Converter - Frontend
**Технологии:** JavaScript  
**Тип:** Frontend, Хакатон Яндекс.Практикум

Команда 2. Хакатон Яндекс.Практикум: Сервис для конвертации валют. Frontend часть проекта.

[🔗 Репозиторий →](https://github.com/r0meo-1/currency-converter-frontend)
